...
export const authFormSchema = (type: string) =>
	z.object({
		...
		address1:
			type === 'login' ? z.string().optional() : z.string().min(3).max(50),
		city: type === 'login' ? z.string().optional() : z.string().min(3),
		state: type === 'login' ? z.string().optional() : z.string().min(2),
		postalCode:
			type === 'login' ? z.string().optional() : z.string().min(5).max(8),
		dateOfBirth: type === 'login' ? z.string().optional() : z.string().min(3),
		ssn: type === 'login' ? z.string().optional() : z.string().min(4).max(9),
		// login
