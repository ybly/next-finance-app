            ...
            {user ? (
                ...
                <>
                    ...
                    <footer className='flex justify-center gap-1'>
                        <p className='text-14 font-normal text-gray-600'>{type === 'login' ? "Don't have an account?" : 'Already have an account?'}</p>
                        <Link className='form-link' href={type === 'login' ? '/sign-up' : '/login'} >{type === 'login' ? 'Sign Up' : 'Login'}</Link>
                    </footer>
                </>
            )}
